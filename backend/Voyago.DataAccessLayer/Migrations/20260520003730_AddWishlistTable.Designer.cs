...
namespace Voyago.DataAccessLayer.Migrations
{
    ...
    [Migration("20260520003730_AddWishlistTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Voyago.Domain.Entities.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Voyago.Domain.Entities.Wishlist", b =>
                {
                    b.HasOne("Voyago.Domain.Entities.Tour", null)
                        .WithMany()
                        .HasForeignKey("TourId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Voyago.Domain.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
