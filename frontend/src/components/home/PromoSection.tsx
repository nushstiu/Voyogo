...
export default function PromoSection() {
  ...
  return (
    <section className="flex flex-col md:flex-row justify-center gap-6 md:gap-10 px-6 md:px-16 my-10">
      <div
        className="relative w-full md:w-1/2 h-96 rounded-2xl overflow-hidden bg-cover bg-center flex items-end"
        style={{
          backgroundImage:
      ...
      <div
        className="relative w-full md:w-1/3 h-96 rounded-2xl overflow-hidden bg-cover bg-center flex items-center justify-center"
        style={{
          backgroundImage:
